...
#define __PYX_HAVE__gwdt__gwdt_impl
#define __PYX_HAVE_API__gwdt__gwdt_impl
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
 ...
 * 
 */
typedef std::pair<__pyx_t_5numpy_float32_t,__pyx_t_5numpy_uint64_t>  __pyx_t_4gwdt_9gwdt_impl_queue_elem_t;

/* "gwdt/gwdt_impl.pyx":22
 * #
 * ctypedef cpp_pair[np.float32_t, np.uint64_t] queue_elem_t
 * ctypedef priority_queue[queue_elem_t] queue_t             # <<<<<<<<<<<<<<
 * 
 * cdef:
 */
typedef std::priority_queue<__pyx_t_4gwdt_9gwdt_impl_queue_elem_t>  __pyx_t_4gwdt_9gwdt_impl_queue_t;
...
/* Module declarations from 'gwdt.gwdt_impl' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static __pyx_t_5numpy_uint8_t __pyx_v_4gwdt_9gwdt_impl_MARK_OOB;
static __pyx_t_5numpy_uint8_t __pyx_v_4gwdt_9gwdt_impl_MARK_ALIVE;
static __pyx_t_5numpy_uint8_t __pyx_v_4gwdt_9gwdt_impl_MARK_TRIAL;
static __pyx_t_5numpy_uint8_t __pyx_v_4gwdt_9gwdt_impl_MARK_FAR;
...
static void __pyx_f_4gwdt_9gwdt_impl_initialize(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __pyx_t_4gwdt_9gwdt_impl_queue_t &); /*proto*/
static void __pyx_f_4gwdt_9gwdt_impl_do_gwdt_step(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __pyx_t_4gwdt_9gwdt_impl_queue_t &); /*proto*/
...
#define __Pyx_MODULE_NAME "gwdt.gwdt_impl"
extern int __pyx_module_is_main_gwdt__gwdt_impl;
int __pyx_module_is_main_gwdt__gwdt_impl = 0;

/* Implementation of 'gwdt.gwdt_impl' */
...
static const char __pyx_k_gwdt_impl[] = "gwdt_impl";
...
static const char __pyx_k_gwdt_gwdt_impl[] = "gwdt.gwdt_impl";
...
static const char __pyx_k_gwdt_gwdt_impl_pyx[] = "gwdt\\gwdt_impl.pyx";
...
static PyObject *__pyx_n_s_gwdt_gwdt_impl;
static PyObject *__pyx_kp_s_gwdt_gwdt_impl_pyx;
static PyObject *__pyx_n_s_gwdt_impl;
...
static PyObject *__pyx_pf_4gwdt_9gwdt_impl_gwdt_impl(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img, __Pyx_memviewslice __pyx_v_output, __Pyx_memviewslice __pyx_v_strides, __Pyx_memviewslice __pyx_v_marks); /* proto */
...
static PyObject *__pyx_pw_4gwdt_9gwdt_impl_1gwdt_impl(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_memviewslice __pyx_v_marks = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("gwdt_impl (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_img,&__pyx_n_s_output,&__pyx_n_s_strides,&__pyx_n_s_marks,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_output)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("gwdt_impl", 1, 4, 4, 1); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_strides)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gwdt_impl", 1, 4, 4, 2); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_marks)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gwdt_impl", 1, 4, 4, 3); __PYX_ERR(0, 32, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "gwdt_impl") < 0)) __PYX_ERR(0, 32, __pyx_L3_error)
      }
    ...
    __pyx_v_img = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float32_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_img.memview)) __PYX_ERR(0, 32, __pyx_L3_error)
    __pyx_v_output = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float32_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_output.memview)) __PYX_ERR(0, 33, __pyx_L3_error)
    __pyx_v_strides = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_int64_t(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_strides.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_marks = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_uint8_t(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_marks.memview)) __PYX_ERR(0, 35, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("gwdt_impl", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 32, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("gwdt.gwdt_impl.gwdt_impl", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4gwdt_9gwdt_impl_gwdt_impl(__pyx_self, __pyx_v_img, __pyx_v_output, __pyx_v_strides, __pyx_v_marks);
...
static PyObject *__pyx_pf_4gwdt_9gwdt_impl_gwdt_impl(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img, __Pyx_memviewslice __pyx_v_output, __Pyx_memviewslice __pyx_v_strides, __Pyx_memviewslice __pyx_v_marks) {
  __pyx_t_4gwdt_9gwdt_impl_queue_t __pyx_v_queue;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("gwdt_impl", 0);

  /* "gwdt/gwdt_impl.pyx":62
 *      cdef:
 *          queue_t queue
 *      with nogil:             # <<<<<<<<<<<<<<
 ...
 */
        __pyx_f_4gwdt_9gwdt_impl_initialize(__pyx_v_img, __pyx_v_output, __pyx_v_strides, __pyx_v_marks, __pyx_v_queue);

        /* "gwdt/gwdt_impl.pyx":64
 *      with nogil:
 *          initialize(img, output, strides, marks, queue)
 *          while queue.size() > 0:             # <<<<<<<<<<<<<<
 *             do_gwdt_step(img, output, strides, marks, queue)
 ...
 */
        while (1) {
          __pyx_t_1 = ((__pyx_v_queue.size() > 0) != 0);
          if (!__pyx_t_1) break;

          /* "gwdt/gwdt_impl.pyx":65
 *          initialize(img, output, strides, marks, queue)
 *          while queue.size() > 0:
 *             do_gwdt_step(img, output, strides, marks, queue)             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_f_4gwdt_9gwdt_impl_do_gwdt_step(__pyx_v_img, __pyx_v_output, __pyx_v_strides, __pyx_v_marks, __pyx_v_queue);
        }
      }
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_marks, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "gwdt/gwdt_impl.pyx":67
 *             do_gwdt_step(img, output, strides, marks, queue)
 * 
 * cdef void initialize(np.float32_t[:] img,             # <<<<<<<<<<<<<<
 *                      np.float32_t[:] output,
...
static void __pyx_f_4gwdt_9gwdt_impl_initialize(__Pyx_memviewslice __pyx_v_img, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_output, __Pyx_memviewslice __pyx_v_strides, __Pyx_memviewslice __pyx_v_marks, __pyx_t_4gwdt_9gwdt_impl_queue_t &__pyx_v_queue) {
  __pyx_t_5numpy_uint64_t __pyx_v_idx;
  __pyx_t_5numpy_uint64_t __pyx_v_stride_idx;
  __pyx_t_5numpy_uint64_t __pyx_v_trial_idx;
  __pyx_t_4gwdt_9gwdt_impl_queue_elem_t __pyx_v_trial_elem;
  Py_ssize_t __pyx_t_1;
  __pyx_t_5numpy_uint64_t __pyx_t_2;
  int __pyx_t_3;
  Py_ssize_t __pyx_t_4;

  /* "gwdt/gwdt_impl.pyx":77
 ...
 */
    ...
    __pyx_t_3 = (((*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_marks.data + __pyx_t_2 * __pyx_v_marks.strides[0]) ))) == __pyx_v_4gwdt_9gwdt_impl_MARK_OOB) != 0);
    if (__pyx_t_3) {

      /* "gwdt/gwdt_impl.pyx":79
 *     for 0 <= idx < img.shape[0]:
 *         if marks[idx] == MARK_OOB:
 *             continue             # <<<<<<<<<<<<<<
 *         elif marks[idx] == MARK_ALIVE:
 ...
 */
    __pyx_t_2 = __pyx_v_idx;
    __pyx_t_3 = (((*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_marks.data + __pyx_t_2 * __pyx_v_marks.strides[0]) ))) == __pyx_v_4gwdt_9gwdt_impl_MARK_ALIVE) != 0);
    if (__pyx_t_3) {

      /* "gwdt/gwdt_impl.pyx":81
 *             continue
 *         elif marks[idx] == MARK_ALIVE:
 *             for 0 <= stride_idx < strides.shape[0]:             # <<<<<<<<<<<<<<
 *                 trial_idx = idx + strides[stride_idx]
 ...
 */
      __pyx_t_4 = (__pyx_v_strides.shape[0]);
      for (__pyx_v_stride_idx = 0; __pyx_v_stride_idx < __pyx_t_4; __pyx_v_stride_idx++) {

        /* "gwdt/gwdt_impl.pyx":82
 *         elif marks[idx] == MARK_ALIVE:
 *             for 0 <= stride_idx < strides.shape[0]:
 *                 trial_idx = idx + strides[stride_idx]             # <<<<<<<<<<<<<<
 *                 if marks[trial_idx] == MARK_FAR:
 ...
 */
        __pyx_t_2 = __pyx_v_stride_idx;
        __pyx_v_trial_idx = (__pyx_v_idx + (*((__pyx_t_5numpy_int64_t *) ( /* dim=0 */ (__pyx_v_strides.data + __pyx_t_2 * __pyx_v_strides.strides[0]) ))));

        /* "gwdt/gwdt_impl.pyx":83
 *             for 0 <= stride_idx < strides.shape[0]:
 *                 trial_idx = idx + strides[stride_idx]
 *                 if marks[trial_idx] == MARK_FAR:             # <<<<<<<<<<<<<<
 *                      trial_elem.first = -img[trial_idx]
 ...
 */
        __pyx_t_2 = __pyx_v_trial_idx;
        __pyx_t_3 = (((*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_marks.data + __pyx_t_2 * __pyx_v_marks.strides[0]) ))) == __pyx_v_4gwdt_9gwdt_impl_MARK_FAR) != 0);
        if (__pyx_t_3) {

          /* "gwdt/gwdt_impl.pyx":84
 *                 trial_idx = idx + strides[stride_idx]
 *                 if marks[trial_idx] == MARK_FAR:
 *                      trial_elem.first = -img[trial_idx]             # <<<<<<<<<<<<<<
 *                      trial_elem.second = trial_idx
 ...
 */
          __pyx_t_2 = __pyx_v_trial_idx;
          __pyx_v_trial_elem.first = (-(*((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_img.data + __pyx_t_2 * __pyx_v_img.strides[0]) ))));

          /* "gwdt/gwdt_impl.pyx":85
 *                 if marks[trial_idx] == MARK_FAR:
 *                      trial_elem.first = -img[trial_idx]
 *                      trial_elem.second = trial_idx             # <<<<<<<<<<<<<<
 *                      queue.push(trial_elem)
 ...
 */
          __pyx_v_trial_elem.second = __pyx_v_trial_idx;

          /* "gwdt/gwdt_impl.pyx":86
 *                      trial_elem.first = -img[trial_idx]
 *                      trial_elem.second = trial_idx
 *                      queue.push(trial_elem)             # <<<<<<<<<<<<<<
 *                      marks[trial_idx] = MARK_TRIAL
 * 
 */
          __pyx_v_queue.push(__pyx_v_trial_elem);

          /* "gwdt/gwdt_impl.pyx":87
 *                      trial_elem.second = trial_idx
 *                      queue.push(trial_elem)
 *                      marks[trial_idx] = MARK_TRIAL             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_t_2 = __pyx_v_trial_idx;
          *((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_marks.data + __pyx_t_2 * __pyx_v_marks.strides[0]) )) = __pyx_v_4gwdt_9gwdt_impl_MARK_TRIAL;
...
static void __pyx_f_4gwdt_9gwdt_impl_do_gwdt_step(__Pyx_memviewslice __pyx_v_img, __Pyx_memviewslice __pyx_v_output, __Pyx_memviewslice __pyx_v_strides, __Pyx_memviewslice __pyx_v_marks, __pyx_t_4gwdt_9gwdt_impl_queue_t &__pyx_v_queue) {
  __pyx_t_4gwdt_9gwdt_impl_queue_elem_t __pyx_v_trial_elem;
  __pyx_t_5numpy_uint64_t __pyx_v_stride_idx;
  __pyx_t_5numpy_uint64_t __pyx_v_trial_idx;
  __pyx_t_5numpy_float32_t __pyx_v_weight;
  __pyx_t_5numpy_uint64_t __pyx_v_candidate_idx;
  __pyx_t_5numpy_uint8_t __pyx_v_candidate_mark;
  __pyx_t_4gwdt_9gwdt_impl_queue_elem_t __pyx_v_candidate_elem;
  __pyx_t_5numpy_uint64_t __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
  Py_ssize_t __pyx_t_4;

  /* "gwdt/gwdt_impl.pyx":103
 ...
 */
  __pyx_v_trial_elem = __pyx_v_queue.top();

  /* "gwdt/gwdt_impl.pyx":104
 * 
 *     trial_elem = queue.top()
 *     queue.pop()             # <<<<<<<<<<<<<<
 *     weight = -trial_elem.first
 ...
 */
  __pyx_v_weight = (-__pyx_v_trial_elem.first);

  /* "gwdt/gwdt_impl.pyx":106
 *     queue.pop()
 *     weight = -trial_elem.first
 *     trial_idx = trial_elem.second             # <<<<<<<<<<<<<<
 *     if marks[trial_idx] != MARK_ALIVE or output[trial_idx] > weight:
 ...
 */
  __pyx_t_1 = __pyx_v_trial_elem.second;
  __pyx_v_trial_idx = __pyx_t_1;

  /* "gwdt/gwdt_impl.pyx":107
 *     weight = -trial_elem.first
 *     trial_idx = trial_elem.second
 *     if marks[trial_idx] != MARK_ALIVE or output[trial_idx] > weight:             # <<<<<<<<<<<<<<
 *         # A better path has already been found if MARK_ALIVE
 ...
 */
  __pyx_t_1 = __pyx_v_trial_idx;
  __pyx_t_3 = (((*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_marks.data + __pyx_t_1 * __pyx_v_marks.strides[0]) ))) != __pyx_v_4gwdt_9gwdt_impl_MARK_ALIVE) != 0);
  if (!__pyx_t_3) {
  } else {
    __pyx_t_2 = __pyx_t_3;
  ...
  __pyx_t_1 = __pyx_v_trial_idx;
  __pyx_t_3 = (((*((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_output.data + __pyx_t_1 * __pyx_v_output.strides[0]) ))) > __pyx_v_weight) != 0);
  __pyx_t_2 = __pyx_t_3;
  __pyx_L4_bool_binop_done:;
  if (__pyx_t_2) {

    /* "gwdt/gwdt_impl.pyx":109
 *     if marks[trial_idx] != MARK_ALIVE or output[trial_idx] > weight:
 *         # A better path has already been found if MARK_ALIVE
 *         marks[trial_idx] = MARK_ALIVE             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_1 = __pyx_v_trial_idx;
    *((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_marks.data + __pyx_t_1 * __pyx_v_marks.strides[0]) )) = __pyx_v_4gwdt_9gwdt_impl_MARK_ALIVE;

    /* "gwdt/gwdt_impl.pyx":110
 *         # A better path has already been found if MARK_ALIVE
 *         marks[trial_idx] = MARK_ALIVE
 *         output[trial_idx] = weight             # <<<<<<<<<<<<<<
 *         for 0 <= stride_idx < strides.shape[0]:
 ...
 */
    __pyx_t_1 = __pyx_v_trial_idx;
    *((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_output.data + __pyx_t_1 * __pyx_v_output.strides[0]) )) = __pyx_v_weight;

    /* "gwdt/gwdt_impl.pyx":111
 *         marks[trial_idx] = MARK_ALIVE
 *         output[trial_idx] = weight
 *         for 0 <= stride_idx < strides.shape[0]:             # <<<<<<<<<<<<<<
 *             candidate_idx = trial_idx + strides[stride_idx]
 ...
 */
      __pyx_t_1 = __pyx_v_stride_idx;
      __pyx_v_candidate_idx = (__pyx_v_trial_idx + (*((__pyx_t_5numpy_int64_t *) ( /* dim=0 */ (__pyx_v_strides.data + __pyx_t_1 * __pyx_v_strides.strides[0]) ))));

      /* "gwdt/gwdt_impl.pyx":113
 *         for 0 <= stride_idx < strides.shape[0]:
 *             candidate_idx = trial_idx + strides[stride_idx]
 *             candidate_mark = marks[candidate_idx]             # <<<<<<<<<<<<<<
 *             if candidate_mark == MARK_TRIAL or candidate_mark == MARK_FAR:
 ...
 */
      __pyx_t_1 = __pyx_v_candidate_idx;
      __pyx_v_candidate_mark = (*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_marks.data + __pyx_t_1 * __pyx_v_marks.strides[0]) )));

      /* "gwdt/gwdt_impl.pyx":114
 *             candidate_idx = trial_idx + strides[stride_idx]
 *             candidate_mark = marks[candidate_idx]
 *             if candidate_mark == MARK_TRIAL or candidate_mark == MARK_FAR:             # <<<<<<<<<<<<<<
 *                 # For trial or far-marked candidates, calculate the weight
 ...
 */
      __pyx_t_3 = ((__pyx_v_candidate_mark == __pyx_v_4gwdt_9gwdt_impl_MARK_TRIAL) != 0);
      if (!__pyx_t_3) {
      } else {
        __pyx_t_2 = __pyx_t_3;
        goto __pyx_L9_bool_binop_done;
      }
      __pyx_t_3 = ((__pyx_v_candidate_mark == __pyx_v_4gwdt_9gwdt_impl_MARK_FAR) != 0);
      __pyx_t_2 = __pyx_t_3;
      __pyx_L9_bool_binop_done:;
      if (__pyx_t_2) {

        /* "gwdt/gwdt_impl.pyx":119
 ...
 */
        __pyx_t_1 = __pyx_v_candidate_idx;
        __pyx_v_candidate_elem.first = (-(__pyx_v_weight + (*((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_img.data + __pyx_t_1 * __pyx_v_img.strides[0]) )))));

        /* "gwdt/gwdt_impl.pyx":120
 *                 #
 *                 candidate_elem.first = -(weight + img[candidate_idx])
 *                 candidate_elem.second = candidate_idx             # <<<<<<<<<<<<<<
 *                 queue.push(candidate_elem)
 ...
 */
        __pyx_v_candidate_elem.second = __pyx_v_candidate_idx;

        /* "gwdt/gwdt_impl.pyx":121
 *                 candidate_elem.first = -(weight + img[candidate_idx])
 *                 candidate_elem.second = candidate_idx
 *                 queue.push(candidate_elem)             # <<<<<<<<<<<<<<
 *                 marks[candidate_idx] = MARK_TRIAL
 * 
 */
        __pyx_v_queue.push(__pyx_v_candidate_elem);

        /* "gwdt/gwdt_impl.pyx":122
 *                 candidate_elem.second = candidate_idx
 *                 queue.push(candidate_elem)
 *                 marks[candidate_idx] = MARK_TRIAL             # <<<<<<<<<<<<<<
 * 
 */
        __pyx_t_1 = __pyx_v_candidate_idx;
        *((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_marks.data + __pyx_t_1 * __pyx_v_marks.strides[0]) )) = __pyx_v_4gwdt_9gwdt_impl_MARK_TRIAL;
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "gwdt.gwdt_impl.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "gwdt.gwdt_impl._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_gwdt_impl(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_gwdt_impl},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_gwdt_gwdt_impl, __pyx_k_gwdt_gwdt_impl, sizeof(__pyx_k_gwdt_gwdt_impl), 0, 0, 1, 1},
  {&__pyx_kp_s_gwdt_gwdt_impl_pyx, __pyx_k_gwdt_gwdt_impl_pyx, sizeof(__pyx_k_gwdt_gwdt_impl_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_gwdt_impl, __pyx_k_gwdt_impl, sizeof(__pyx_k_gwdt_impl), 0, 0, 1, 1},
 ...
 *               np.int64_t[:] strides,
 */
  __pyx_tuple__22 = PyTuple_Pack(5, __pyx_n_s_img, __pyx_n_s_output, __pyx_n_s_strides, __pyx_n_s_marks, __pyx_n_s_queue); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(4, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_gwdt_gwdt_impl_pyx, __pyx_n_s_gwdt_impl, 32, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 32, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initgwdt_impl(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initgwdt_impl(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_gwdt_impl(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_gwdt_impl(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_gwdt_impl(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'gwdt_impl' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_gwdt_impl(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("gwdt_impl", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_gwdt__gwdt_impl) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "gwdt.gwdt_impl")) {
      if (unlikely(PyDict_SetItemString(modules, "gwdt.gwdt_impl", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  __pyx_v_4gwdt_9gwdt_impl_MARK_OOB = 0;

  /* "gwdt/gwdt_impl.pyx":26
 * cdef:
 *     np.uint8_t MARK_OOB = 0
 *     np.uint8_t MARK_ALIVE = 1             # <<<<<<<<<<<<<<
 *     np.uint8_t MARK_TRIAL = 2
 ...
 */
  __pyx_v_4gwdt_9gwdt_impl_MARK_ALIVE = 1;

  /* "gwdt/gwdt_impl.pyx":27
 *     np.uint8_t MARK_OOB = 0
 *     np.uint8_t MARK_ALIVE = 1
 *     np.uint8_t MARK_TRIAL = 2             # <<<<<<<<<<<<<<
 *     np.uint8_t MARK_FAR = 3
 * 
 */
  __pyx_v_4gwdt_9gwdt_impl_MARK_TRIAL = 2;

  /* "gwdt/gwdt_impl.pyx":28
 *     np.uint8_t MARK_ALIVE = 1
 *     np.uint8_t MARK_TRIAL = 2
 *     np.uint8_t MARK_FAR = 3             # <<<<<<<<<<<<<<
 * 
 * np.import_array()
 */
  __pyx_v_4gwdt_9gwdt_impl_MARK_FAR = 3;

  /* "gwdt/gwdt_impl.pyx":30
 *     np.uint8_t MARK_FAR = 3
 * 
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 *               np.int64_t[:] strides,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4gwdt_9gwdt_impl_1gwdt_impl, NULL, __pyx_n_s_gwdt_gwdt_impl); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_gwdt_impl, __pyx_t_1) < 0) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "gwdt/gwdt_impl.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init gwdt.gwdt_impl", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init gwdt.gwdt_impl");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
